...
public class Start {
	...
	public static void main(String[] args) {
		...
		/*
		 * AbstractORASlover solver = new
		 * ORASolverByIteratingExchange(ModelFactoryN.testModel());
...
//			
			/*
			 * solver=new ORASolverByCPNonObjective(problem); solver.solve(false,false);
			 * solver.print();
			 */
			...
			int exeAct3 = solver.getExecutedActivityNumber();
		...
		/*
		 * Model model=ModelFactory.makeFullModel(); model.print();
		 * 
		 * 
		 * ParallelScheduling scheduling=new ParallelScheduling(model);
		 * //SerialScheduling scheduling=new SerialScheduling(model); scheduling.run();
		 * 
		 * show(model);
		 * 
